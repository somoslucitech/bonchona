...
export default function QuienesSomosPage() {
  return (
    <div className="flex flex-col items-center w-full bg-bonchona-navy text-white min-h-screen overflow-x-hidden">
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center z-10 border-t border-white/5">
         <div className="relative group order-2 lg:order-1">
            ...
            <div className="relative glass rounded-[3rem] overflow-hidden border-white/10 p-10 aspect-square flex flex-col items-center justify-center">
               <Image src="/logos-bonchona/92.png" className="w-40 h-40 object-contain opacity-10 grayscale absolute" alt="Bonchona Logo" width={160} height={160} />
               <div className="relative z-10 text-center">
                  <motion.p 
                    whileInView={{ scale: 1.1 }}
                    className="text-bonchona-red text-8xl font-black italic mb-4 tracking-tighter"
                  >
                    1997
                  </motion.p>
                  <p className="text-white text-[10px] font-black uppercase tracking-[0.4em] opacity-60">El inicio de un sueño</p>
               </div>
            </div>
         </div>
      ...
      <section className="w-full bg-bonchona-navy/50 py-20 z-10 border-y border-white/5">
         <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="text-zinc-500 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed mb-20 font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
               {[
                  ...
                  <motion.div 
                    key={i} 
                    whileHover={{ y: -10 }}
                    className="p-10 rounded-[3rem] glass border-white/5 hover:border-bonchona-red/30 transition-all group shadow-xl"
                  >
                     <h4 className="text-bonchona-red font-black uppercase italic text-2xl mb-6 tracking-tighter group-hover:translate-x-2 transition-transform leading-none">{item.title}</h4>
      ...
      <section className="w-full py-24 px-6 z-10 bg-bonchona-red relative overflow-hidden shadow-2xl">
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16 text-center text-black">
            {[
               ...
               <div key={i} className="flex flex-col items-center">
                  <span className="text-6xl md:text-7xl font-black italic mb-2 tracking-tighter">{stat.val}</span>
                  <span className="text-black font-black uppercase tracking-[0.3em] text-[9px] opacity-60">{stat.label}</span>
               </div>
            ))}
         </div>
      </section>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-40 text-center z-10 relative border-t border-white/5">
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-bonchona-red/5 blur-[150px] -z-10"></div>
         <motion.h2 
         ...
         >
           <Link href="/" className="px-16 py-7 bg-bonchona-red text-white font-black rounded-full shadow-[0_20px_40px_rgba(232,75,50,0.3)] uppercase tracking-[0.3em] text-sm">
              Escuchar en Vivo
           </Link>
         </motion.div>
      </section>
