    ...
    <html lang="es" className="dark" suppressHydrationWarning>
      ...
      >
        ...
        <nav className="fixed top-0 w-full z-50 glass border-b border-white/5">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              <Image src="/logos-bonchona/92.png" alt="Bonchona" className="h-12 w-auto object-contain" width={48} height={48} />
            </Link>
        ...
        <a 
          ...
          className="fixed bottom-36 right-6 md:right-12 z-[40] group flex items-center gap-4"
        >
          <div className="glass text-white text-[10px] font-black uppercase tracking-[0.2em] px-5 py-2.5 rounded-full border border-white/10 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-4 group-hover:translate-x-0 shadow-2xl pointer-events-none">
            Pidelá!
          </div>
          <div className="w-16 h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-[0_20px_40px_rgba(37,211,102,0.3)] hover:scale-110 hover:rotate-12 transition-all duration-500 relative">
